  ...
  nouvelleVersion () {
    ...
    for (let i = 0, texte, texteCorr, cpt = 0;
      ...
      if (listeTypeDeQuestions[i] < 3) {
        ...
        pb3f[0].enonce += `<br>À chaque entraînement, il parcourt le circuit de la façon suivante : $${(pb3f[0].fractions[0] as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[1]}, `
        pb3f[0].enonce += `$${(pb3f[0].fractions[2] as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[3]} et le reste à ${pb3f[0].fractions[5]}.`
        ...
        denominateurCommun = (listefrac.listeMemeDenominateur[0] as unknown as FractionEtendue).den
        for (let i = 0; i < 2; i++) {
          ...
          if (listefrac.liste[0].den === listefrac.liste[1].den) {
            ...
            if (listefrac.liste[0].den !== denominateurCommun) pb3f[i].correction += `$= ${(listefrac.listeMemeDenominateur[0] as unknown as FractionEtendue).texFraction}$ et `
            else pb3f[i].correction += ' et '
            pb3f[i].correction += `$${listefrac.liste[1].texFraction}$ `
            if (listefrac.liste[1].den !== denominateurCommun) pb3f[i].correction += `$= ${(listefrac.listeMemeDenominateur[1] as unknown as FractionEtendue).texFraction}$.<br>`
        ...
        for (let i = 0; i < 2; i++) {
          ...
          pb3f[i].correction += `$1-${(pb3f[i].fractions[0] as FractionEtendue).texFraction}-${(pb3f[i].fractions[2] as FractionEtendue).texFraction} = `
          pb3f[i].correction += `${fraction(denominateurCommun, denominateurCommun).texFraction}-${(listefrac.listeMemeDenominateur[0] as unknown as FractionEtendue).texFraction}-${(listefrac.listeMemeDenominateur[1] as unknown as FractionEtendue).texFraction} = `
          pb3f[i].correction += `\\dfrac{${denominateurCommun}-${(listefrac.listeMemeDenominateur[0] as unknown as FractionEtendue).num}-${(listefrac.listeMemeDenominateur[1] as unknown as FractionEtendue).num}}{${denominateurCommun}} = `
          pb3f[i].correction += `${fraction(denominateurCommun - (listefrac.listeMemeDenominateur[0] as unknown as FractionEtendue).num - (listefrac.listeMemeDenominateur[1] as unknown as FractionEtendue).num, denominateurCommun).texFraction}`
          if (!(denominateurCommun === F3.den)) {
            pb3f[i].correction += ` = ${(pb3f[i].fractions[4] as FractionEtendue).texFraction}$`
          } else {
            pb3f[i].correction += '$'
          }
        }
        ...
        //= =====================================================
        pb3f[0].correction += `<br>${pb3f[0].prenoms[0]} fait donc $${(pb3f[0].fractions[0] as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[1]}, `
        pb3f[0].correction += `$${(pb3f[0].fractions[2] as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[3]} et `
        pb3f[0].correction += `$${(pb3f[0].fractions[4] as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[5]}.`

        pb3f[0].correction += '<br> Avec les mêmes dénominateurs pour pouvoir comparer, '
        pb3f[0].correction += `${pb3f[0].prenoms[0]} fait donc $${(fracMemeDenom[0] as unknown as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[1]}, `
        pb3f[0].correction += `$${(fracMemeDenom[1] as unknown as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[3]} et `
        pb3f[0].correction += `$${(fracMemeDenom[2] as unknown as FractionEtendue).texFraction}$ à ${pb3f[0].fractions[5]}.`
        ...
        //= =====================================================
        pb3f[1].correction += `<br>${pb3f[1].fractions[1]} a donc remporté $${(pb3f[1].fractions[0] as FractionEtendue).texFraction}$, `
        pb3f[1].correction += `${pb3f[1].fractions[3]} a remporté $${(pb3f[1].fractions[2] as FractionEtendue).texFraction}$ et `
        pb3f[1].correction += `${pb3f[1].fractions[5]} $${(pb3f[1].fractions[4] as FractionEtendue).texFraction}$.`
        ...
        denominateurCommun = (listefrac2.listeMemeDenominateur[0] as unknown as FractionEtendue).den
        for (let i = 0; i < 3; i++) {
          ...
          if (listefrac2.liste[0].den === denominateurCommun && listefrac2.liste[1].den === denominateurCommun && listefrac2.liste[2].den === denominateurCommun) {
            ...
            if (listefrac2.liste[0].den !== denominateurCommun) pb4f[i].correction += `$= ${(listefrac2.listeMemeDenominateur[0] as unknown as FractionEtendue).texFraction}$ ; `
            else pb4f[i].correction += ' ; '
            pb4f[i].correction += `$${listefrac2.liste[1].texFraction}$ `
            if (listefrac2.liste[1].den !== denominateurCommun) pb4f[i].correction += `$= ${(listefrac2.listeMemeDenominateur[1] as unknown as FractionEtendue).texFraction}$ et `
            else pb4f[i].correction += ' et '
            pb4f[i].correction += `$${listefrac2.liste[2].texFraction}$ `
            if (listefrac2.liste[2].den !== denominateurCommun) pb4f[i].correction += `$= ${(listefrac2.listeMemeDenominateur[2] as unknown as FractionEtendue).texFraction}$.<br>`
        ...
        for (let i = 0; i < 3; i++) {
          ...
          pb4f[i].correction += `$1-${(pb4f[i].fractions[0] as FractionEtendue).texFraction}-${(pb4f[i].fractions[2] as FractionEtendue).texFraction}-${(pb4f[i].fractions[4] as FractionEtendue).texFraction} = `
          pb4f[i].correction += `\\dfrac{${denominateurCommun}}{${denominateurCommun}}-${(fracMemeDenom[0] as unknown as FractionEtendue).texFraction}-${(fracMemeDenom[1] as unknown as FractionEtendue).texFraction}-${(fracMemeDenom[2] as unknown as FractionEtendue).texFraction} = `
          pb4f[i].correction += `\\dfrac{${denominateurCommun}-${(fracMemeDenom[0] as unknown as FractionEtendue).num}-${(fracMemeDenom[1] as unknown as FractionEtendue).num}-${(fracMemeDenom[2] as unknown as FractionEtendue).num}}{${denominateurCommun}} = `
          pb4f[i].correction += `${(fracMemeDenom[3] as unknown as FractionEtendue).texFraction}`
          if ((fracMemeDenom[3] as unknown as FractionEtendue).den !== (pb4f[i].fractions[6] as unknown as FractionEtendue).den) {
            pb4f[i].correction += ` = ${(pb4f[i].fractions[6] as FractionEtendue).texFraction}$`
          } else {
            pb4f[i].correction += '$'
          }
        }
        ...
        if (
          (pb4f[0].fractions[0] as FractionEtendue).isEqual(pb4f[0].fractions[2] as FractionEtendue) &&
                 (pb4f[0].fractions[0] as FractionEtendue).isEqual(pb4f[0].fractions[4] as FractionEtendue) &&
                 (pb4f[0].fractions[0] as FractionEtendue).isEqual(pb4f[0].fractions[6] as FractionEtendue)
        ) {
        ...
        // let fracRangees,fracMemeDenomRangees;
        if (
          (pb4f[1].fractions[0] as FractionEtendue).isEqual(pb4f[1].fractions[2] as FractionEtendue) &&
                (pb4f[1].fractions[0] as FractionEtendue).isEqual(pb4f[1].fractions[4] as FractionEtendue) &&
                (pb4f[1].fractions[0] as FractionEtendue).isEqual(pb4f[1].fractions[6] as FractionEtendue)
        ) {
        ...
        // let fracRangees,fracMemeDenomRangees;
        if (
          (pb4f[2].fractions[0] as FractionEtendue).isEqual(pb4f[2].fractions[2] as FractionEtendue) &&
                  (pb4f[2].fractions[0] as FractionEtendue).isEqual(pb4f[2].fractions[4] as FractionEtendue) &&
                  (pb4f[2].fractions[0] as FractionEtendue).isEqual(pb4f[2].fractions[6] as FractionEtendue)
        ) {
