...
export default class NomExercice extends Exercice {
  ...
  nouvelleVersion () {
    ...
    if (context.isHtml) {
      this.correction += '<div class="text-coopmaths-struct font-bold my-4">Démonstration de cours en vidéo</div>'
      this.correction += '<iframe src="https://podeduc.apps.education.fr/video/89920-demontrer-que-le-nombre-total-de-parties-dun-ensemble-a-n-elements-est-egal-a-2-puissance-n/?is_iframe=true" width="640" height="360" style="padding: 0; margin: 0; border:0" allowfullscreen title="Démontrer que le nombre total de parties d\'un ensemble à n éléments est égal à 2 puissance n" ></iframe>'
    }
    this.reponse = 2 ** n
  }
}
