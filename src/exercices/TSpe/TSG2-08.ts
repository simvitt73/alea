...
export default class NomExercice extends Exercice {
  ...
  nouvelleVersion () {
    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      let u1 = new FractionEtendue(vx, ux)
      let u2 = new FractionEtendue(vy, uy)
      let u3 = new FractionEtendue(vz, uz)
      ...
      switch (listeTypeQuestions[i]) {
        case 'type2':// Droites non-coplanaires
          ...
          u1 = new FractionEtendue(vx, ux)
          u2 = new FractionEtendue(vy, uy)
          u3 = new FractionEtendue(vz, uz)
          ...
          texteCorr += `<br>$\\begin{cases}
            ${new FractionEtendue(vx, ux).texFractionSimplifiee}s ${new FractionEtendue(xB - xA, ux).texFractionSignee}=${new FractionEtendue(vy, uy).texFractionSimplifiee}s ${new FractionEtendue(yB - yA, uy).texFractionSignee} \\\\\\\\
            ...
            \\end{cases}$`
          texteCorr += `<br><br>$\\begin{cases}
            \\left(${u1.texFractionSimplifiee}-${u2.texFractionSimplifiee}\\right)s =${new FractionEtendue(yB - yA, uy).texFractionSignee}-${new FractionEtendue(xB - xA, ux).texFractionSignee} \\\\\\\\
            \\left(${u1.texFractionSimplifiee}-${u3.texFractionSimplifiee}\\right)s = ${new FractionEtendue(zB - zA, uz).texFractionSignee}-${new FractionEtendue(xB - xA, ux).texFractionSignee}
            \\end{cases}$`

          texteCorr += `<br><br>$\\begin{cases}
            ${u1.differenceFraction(u2)}s =${new FractionEtendue(yB - yA, uy).texFractionSignee} \\\\\\\\
            ${u1.differenceFraction(u3)}s = ${new FractionEtendue(zB - zA, uz).texFractionSignee}
            \\end{cases}$`
