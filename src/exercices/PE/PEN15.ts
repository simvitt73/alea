...
import { analyzeDecimal, texNombreAvecZeroInutile, toFixedTruncate } from './PEN14'
...
export default class nomExercice extends Exercice {
  ...
  nouvelleVersion () {
    ...
    let correction2 = '$A$ est un nombre rationnel non décimal donc son écriture décimale est illimitée et périodique.'
    correction2 += '<br>'
