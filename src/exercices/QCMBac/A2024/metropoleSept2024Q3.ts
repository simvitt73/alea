...
export const titre = 'QCM Bac Métropole septembre 2024 : position droite-plan'
...
$\\bullet~~$ Le plan $\\mathcal{Q}$ d'équation cartésienne : $-6 x-4 y-2 z+7=0$.<br>`
    ...
    this.correction += '$\\vec v\\cdot \\vec n = -1\\times 3 +0\\times 2+3\\times 1 = 0$ donc $\\vec v\\perp \\vec n$,<br>'
