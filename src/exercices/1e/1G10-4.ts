import { milieu, point, pointAdistance, tracePointSurDroite } from '../../lib/2d/points'
    ...
    for (let i = 0, texte, texteCorr, reponse, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      switch (listeTypeDeQuestions[i]) { // listeTypeDeQuestions[i]
        case 1 :// carré
        {
          ...
          objets.push(labelPoint(A, B, C, D, I, O), a1, a2, poly, OI, segment(A, C), segment(I, D), segment(B, D), codageSegment(A, I, '||'), codageAngleDroit(B, I, O), codageSegment(I, B, '||'))
          ...
          switch (randint(6, 6)) {
            case 1 :// AB.AC ou AB.AO
              ...
              texte += mathalea2d({ xmin, ymin, xmax, ymax, pixelsParCm: 15, mainlevee: false, amplitude: 0.3, scale: 0.4, style: 'margin: auto' }, objets)
              ...
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{AB}\\cdot ${choixb ? '\\overrightarrow{AC}' : '\\overrightarrow{AO}'}=$` })
              break
            ...
            case 2 :// CA.AI ou CA.AB
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{CA}\\cdot ${choixb ? '\\overrightarrow{AI}' : '\\overrightarrow{AB}'}=$` })
              break
            ...
            case 3 :// AB.OD ou AB.DO
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{AB}\\cdot ${choixb ? '\\overrightarrow{OD}' : '\\overrightarrow{DO}'}=$` })
              break
            case 4 :// CB.CA ou CB.CI ou BC.CI ou BC.CA
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? '\\overrightarrow{CB}' : '\\overrightarrow{BC}'}\\cdot ${choixb ? '\\overrightarrow{CA}' : '\\overrightarrow{CI}'}=$` })
              break
            case 5 :// OC.BI ou OC.IB
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{OC}\\cdot ${choixb ? '\\overrightarrow{IB}' : '\\overrightarrow{BI}'}=$` })
              break
            ...
            default:
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixb ? '\\overrightarrow{ID}' : '\\overrightarrow{DI}'}\\cdot \\overrightarrow{BC}=$` })
              break
          }
          break
        }
        case 2: //
        {
          ...
          objets.push(labelPoint(A, B, C, H), a2, a1, a3, poly, segment(A, C), segment(A, C), segment(B, C), codageAngleDroit(A, H, C), segment(H, C))
          texte = '$ABC$ est un triangle et $H$ est le pied de la hauteur issue de $B$.<br>'
          switch (randint(1, 2)) {
            ...
            default:
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? `\\overrightarrow{HB}\\cdot ${choixb ? '\\overrightarrow{AC}' : '\\overrightarrow{CA}'}` : `\\overrightarrow{BH}\\cdot ${choixb ? '\\overrightarrow{AC}' : '\\overrightarrow{CA}'}`}=$` })
              break
          }
          break
        }
        ...
        default:
        {
          ...
          objets.push(labelPoint(A, B, C, D, E, F, H), AB, segment(A, C), segment(C, D), segment(D, E), segment(C, E), segment(E, F), segment(F, B), segment(F, C), codageAngleDroit(B, A, C), codageAngleDroit(B, H, E))
          ...
          switch (randint(1, 4)) {
            case 1 :// AB.DE ou AB.ED ou BA.DE ou BA.ED
              ...
              texte += mathalea2d({ xmin, ymin, xmax, ymax, pixelsParCm: 25, mainlevee: false, amplitude: 0.3, scale: 0.4, style: 'margin: auto' }, objets)
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? `\\overrightarrow{AB}\\cdot ${choixb ? '\\overrightarrow{DE}' : '\\overrightarrow{ED}'}` : `\\overrightarrow{BA}\\cdot ${choixb ? '\\overrightarrow{DE}' : '\\overrightarrow{ED}'}`}=$` })
              break
            ...
            case 2 :// AD.CF et ...
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? `\\overrightarrow{AD}\\cdot ${choixb ? '\\overrightarrow{CF}' : '\\overrightarrow{FC}'}` : `\\overrightarrow{DA}\\cdot ${choixb ? '\\overrightarrow{CF}' : '\\overrightarrow{FC}'}`}=$` })
              break
            ...
            case 3 :// CE.DB et ...
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? `\\overrightarrow{CE}\\cdot ${choixb ? '\\overrightarrow{DB}' : '\\overrightarrow{BD}'}` : `\\overrightarrow{EC}\\cdot ${choixb ? '\\overrightarrow{DB}' : '\\overrightarrow{BD}'}`}=$` })
              break
            ...
            default:
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choixa ? `\\overrightarrow{DC}\\cdot ${choixb ? '\\overrightarrow{BH}' : '\\overrightarrow{HB}'}` : `\\overrightarrow{CD}\\cdot ${choixb ? '\\overrightarrow{BH}' : '\\overrightarrow{HB}'}`}=$` })
              break
          }
          break
        }
