...
export const titre = "Choisir le calcul pour calculer un prix après une baisse"
...
Ainsi, le nouveau prix est donné par : $${miseEnEvidence(`${texNombre(prixInitial)} \\times \\dfrac{${100-pourcentage}}{100}`)}$.`
      },
      {
        ...
        correction: `Diminuer de $${pourcentage}\\,\\%$ revient à conserver $${100-pourcentage}\\,\\%$ du prix initial.<br>
On peut factoriser le calcul : $${texNombre(prixInitial)} \\times \\dfrac{${100-pourcentage}}{100} = ${texNombre(prixInitial/10)} \\times 10 \\times \\dfrac{${100-pourcentage}}{100} = ${texNombre(prixInitial/10)} \\times \\dfrac{${100-pourcentage}}{10}$.<br>
