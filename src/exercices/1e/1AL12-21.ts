  ...
  nouvelleVersion() {
    ...
    for (
      ...
      switch (
        ...
        case 1: {
          // Suite arithmétique (u_{n+1}=u_n+a avec u_0=premier_terme)
        ...
        case 2: {
          // Suite définie par u_{n+1}=u_n+b*n avec u_0=u_0
        ...
        default: {
          // Case 3 // Suite définie par u_{n+1}=u_n+c*n+d avec u_0=u
