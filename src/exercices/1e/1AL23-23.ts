  ...
  nouvelleVersion() {
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      if (coeffAA === 0) {
        ...
        if (coeffBB > 0) {
          // Delta est une droite croissante
          ...
          // Delta est une droite décroissante
          texteCorr += `<br>Cherchons la valeur de $m$ qui annule cette expression du premier degré : $m=${m1}$`
          ...
          if (coeffCC === 0) {
            ...
            texteCorr +=
              "<br>Quelque soit $m$ réel, on a $\\Delta$ qui est strictement négatif. L'équation du départ admet jamais de solution réelle."
          }
        }
      } else {
        texteCorr +=
        ...
        if (deltaPrime < 0) {
          ...
          if (coeffAA > 0) {
            ...
            texteCorr +=
              "<br>- Si $m\\in ]-\\infty,m_1[\\cup]m_2,+\\infty[$, l'équation admet n'a pas de solution réelle"
          }
        }
