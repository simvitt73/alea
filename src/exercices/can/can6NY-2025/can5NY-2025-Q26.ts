  ...
  nouvelleVersion () {
    ...
    switch (randint(1,4)) {
      case 1 :
        ...
        this.correction = `$${texNombre(20.25,2)} \\text{ h }=20 \\text{ h } ${miseEnEvidence(this.reponse)} \\text{ min. }$`
      ...
      case 2 :
        ...
        this.correction = `$${texNombre(202.5,1)} \\text{ h }=202 \\text{ h } ${miseEnEvidence(this.reponse)} \\text{ min. }$`
        handleAnswers(this, 0, { champ1: { value: this.reponse } })
      ...
      case 3 :
        ...
        this.correction = `$20 \\text{ h } 15 \\text{ min }= ${miseEnEvidence(this.reponse)} \\text{ h. }$`
        handleAnswers(this, 0, { champ1: { value: this.reponse } })
      ...
      case 4 :
        ...
        this.correction = `$202 \\text{ h } 30 \\text{ min }= ${miseEnEvidence(this.reponse)} \\text{ h. }$`
        handleAnswers(this, 0, { champ1: { value: this.reponse } })
