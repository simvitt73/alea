...
*/
export default class EcritureScientifique extends ExerciceSimple {
  constructor() {
    super()
  ...
  nouvelleVersion() {
    const a = this.canOfficielle
      ? new Decimal(224).div(100)
      : new Decimal(randint(101, 299, 200)).div(100)
    ...
    this.reponse = {
      reponse: {
        value: `${stringNombre(a)}\\times 10^{${puiss}}`,
