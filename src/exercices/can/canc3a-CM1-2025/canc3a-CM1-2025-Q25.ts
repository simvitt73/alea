 ...
 * @author Gilles Mora
 */
export default class Can2025CM1Q25 extends ExerciceSimple {
  constructor() {
    super()
  ...
  nouvelleVersion() {
    ...
    this.correction =
      qcm.texteCorr +
      `Le résultat est dans le même ordre de grandeur que $10\\times ${texNombre(b + 1, 0)}= ${texNombre(10 * b + 10, 0)}$. <br>
