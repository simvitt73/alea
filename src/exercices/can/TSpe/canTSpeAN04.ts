...
export default class logarithme extends Exercice {
  ...
  nouvelleVersion () {
    ...
    &=${a1} \\times ${ecritureParentheseSiNegatif(n1)}${ecritureAlgebrique(a2)} \\times 0${ecritureAlgebriqueSauf1(a3)} \\ln\\left(\\text{e}^{${-n3}}\\right)${ecritureAlgebrique(a4)}\\times ${ecritureParentheseSiNegatif(n4)}\\\\
    &=${a1 * n1} ${ecritureAlgebrique(a3)} \\times ${ecritureParentheseSiNegatif(-n3)}${ecritureAlgebrique(a4 * n4)}\\\\
