...
class AgrandirReduireFigure extends Exercice {
  constructor() {
    ...
    this.spacing = 2
    this.comment =
      "Parce que, selon les questions, le nombre de réponses attendu n'est pas identique, cet exercice ne doit pas être utilisé sous Capytale sous peine de ne pas avoir le même nombre de champs réponse par élève et un problème dana le bilan numérique."
  }
          ...
          case 3:
            {
              ...
              if (this.interactif) {
                ...
                nbDeChampsReponse++
                texte +=
                  '<br> Dans le nouveau triangle, la dernière longueur sera :' +
                  ajouteChampTexteMathLive(
                    this,
                    indiceChampReponse + nbDeChampsReponse,
                    '',
