...
export default class MesurerUnAngleAvecRapporteur extends Exercice {
  ...
  nouvelleVersion () {
    ...
    for (let i = 0, texteAMC, posA, sudOuest, nordOuest, sudEst, nordEst, texte, texteCorr; i < this.nbQuestions; i++) {
      ...
      if (this.interactif) {
        texte += ajouteChampTexteMathLive(this, i * nbAngles, '', { texteApres: ' °' })
      }
      ...
      if (nbAngles > 1) {
        const angD = (this.sup4 && nbAngles === 2) ? angleModulo(180 - angC) : sensRot * sensRot2 * randint(10, 170 - 20 * (nbAngles - 2) - Math.abs(angC))
        ...
        if (this.interactif) {
          texte += ajouteChampTexteMathLive(this, i * nbAngles + 1, '', { texteApres: ' °' })
        }
        ...
        if (nbAngles > 2) {
          const angE = (this.sup4 && nbAngles === 3) ? angleModulo(180 - angC - angD) : sensRot * sensRot2 * randint(10, 170 - 20 * (nbAngles - 3) - Math.abs(angC + angD))
          ...
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, i * nbAngles + 2, '', { texteApres: ' °' })
          }
          ...
          if (nbAngles > 3) {
            const angF = (this.sup4) ? angleModulo(180 - angC - angD - angE) : sensRot * sensRot2 * randint(10, 170 - Math.abs(angC + angD + angE))
            ...
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, i * nbAngles + 3, '', { texteApres: ' °' })
            }
