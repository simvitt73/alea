...
import {
  ...
  minToHour,
  nomDuMois,
} from '../../lib/outils/dateEtHoraires'
import {
  miseEnEvidence,
                  ...
                  propositions: [
                    {
                      enonce:
                        texte +
                        '<br><br>Indique, ci-dessous, le(s) calcul(s) effectué(s) et code ensuite le résultat.',
                      sanscadre: true,
                      texte: texteCorr,
                      statut: 3,
                    },
                      ...
                      propositions: [
                        {
                          ...
                          reponse: {
                            ...
                            param: {
                              ...
                              decimals:
                                nombreDeChiffresDansLaPartieDecimale(reponse2),
                              signe: false,
                              approx: 0,
                            },
                          },
