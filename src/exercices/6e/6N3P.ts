  ...
  nouvelleVersion() {
    ...
    for (
      ...
      objets.push(
        ...
        texteParPoint(
          `${moy1.substring(3)}`,
          pointSurSegment(centre, rotation(depart, centre, p1 * 1.8), 3),
          0,
        ),
      )
      objets.push(
        codageAngle(
          rotation(depart, centre, p1 * 3.6),
          centre,
          p2 * 3.6,
          4.9,
          '',
        ...
        texteParPoint(
          ...
          pointSurSegment(
            centre,
            rotation(depart, centre, p1 * 3.6 + p2 * 1.8),
            3,
          ),
          0,
        ),
      ...
      objets.push(
        ...
        texteParPoint(
          `${moy3.substring(3)}`,
          pointSurSegment(centre, rotation(depart, centre, -p3 * 1.8), 3),
          0,
        ),
      )
