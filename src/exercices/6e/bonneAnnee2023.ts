    ...
    for (
      ...
      switch (QuestionsDisponibles[i]) {
        ...
        case 14: // 4e
          ...
          texteCorr +=
            ' ' +
            RedactionPythagore('E', 'F', 'D', 2, 2023, 2040, 2873, '')[0] +
            '<br>'
          break
        case 15: // 4e
        ...
        case 22: // 1ère
          ...
          texteCorr += mathalea2d(
            ...
            d,
            normale,
            labelPoint(centre1, centre2),
          )
          texteCorr +=
            "<br>Préambule : Soit $y = ax+b$, l'équation de la normale à la parabole en $( x_0 ; x_0^2 )$.<br>"
          texteCorr +=
            sp(29) +
