...
export default class PavagesEtTransformations extends Exercice {
  ...
  nouvelleVersion (numeroExercice: number) {
    ...
    for (let i = 0; i < quad.length; i++) {
      objetsEnonce.push(quad[i], texteParPoint(String(i), barycentre(quad[i], '', 'center'), 0, 'black', 1, 'milieu', false))
      quadCorr[i].color = colorToLatexOrHTML(assombrirOuEclaircir('gray', 50))
      objetsCorrection.push(quadCorr[i], texteParPoint(String(i), barycentre(quad[i], '', 'center'), 0, assombrirOuEclaircir('gray', 50), 1, 'milieu', false))
    }
    ...
    switch (parseInt(this.sup)) {
      case 1: // symétrie axiale
        ...
        while (trouver === false) {
          for (let j = 0; j < nx * ny; j++) {
            if (egal(punto[0], tabfigC[j][0], 0.05) && egal(punto[1], tabfigC[j][1], 0.05)) {
              ...
              xa = tabfigA[indexA][0]
              ya = tabfigA[indexA][1]
              mediatrice1 = mediatrice(point(xa, ya), point(punto[0], punto[1]), '', context.isAmc ? 'black' : 'green') as Droite
        ...
        texte += texteAMC1
        texteCorr += numAlpha(0) + ' La figure symétrique de la figure ' + texteEnCouleurEtGras(`${numA}`, context.isAmc ? 'black' : 'green') + ` dans la symétrie d'axe  $${miseEnEvidence('(d_1)', context.isAmc ? 'black' : 'green')}$  porte le numéro ${texteEnCouleurEtGras(String(num1))}.<br>`
        ...
        while (trouver === false) {
          for (let j = 0; j < nx * ny; j++) {
            if (egal(punto[0], tabfigB[j][0], 0.05) && egal(punto[1], tabfigB[j][1], 0.05)) {
              ...
              mediatrice2 = mediatrice(point(xb, yb + 4), point(punto[0], punto[1]), '', context.isAmc ? 'black' : 'red') as Droite
        ...
        texte += '<br>' + texteAMC2
        texteCorr += '<br>' + numAlpha(1) + ' La figure symétrique de la figure ' + texteEnCouleurEtGras(`${numD}`, context.isAmc ? 'black' : 'red') + ` dans la symétrie d'axe  $${miseEnEvidence('(d_2)', context.isAmc ? 'black' : 'red')}$  porte le numéro ${texteEnCouleurEtGras(String(num2))}.<br>`
        ...
        while (trouver === false) {
          for (let j = 0; j < nx * ny; j++) {
            if (egal(punto[0], tabfigC[j][0], 0.05) && egal(punto[1], tabfigC[j][1], 0.05)) {
              ...
              xc = tabfigC[indexC][0]
              yc = tabfigC[indexC][1]
              mediatrice3 = mediatrice(point(xc, yc), point(punto[0], punto[1]), '', context.isAmc ? 'black' : 'blue') as Droite
        ...
        texte += '<br>' + texteAMC3
        texteCorr += '<br>' + numAlpha(2) + ' La figure symétrique de la figure ' + texteEnCouleurEtGras(`${numC}`, context.isAmc ? 'black' : 'blue') + ` dans la symétrie d'axe  $${miseEnEvidence('(d_3)', context.isAmc ? 'black' : 'blue')}$  porte le numéro ${texteEnCouleurEtGras(String(num3))}.<br>`
        if (mediatrice1 == null || mediatrice2 == null || mediatrice3 == null || num1 == null || num2 == null || num3 == null) {
          throw Error('mediatrice1, mediatrice2 ou mediatrice3 ou num1, num2 ou num3 est null')
        }
      ...
      case 2: // symétrie centrale
        ...
        if (centre1 == null || centre2 == null || centre3 == null || num1 == null || num2 == null || num3 == null) {
