...
export default class AireParComptage extends Exercice {
  ...
  nouvelleVersion () {
    ...
    for (let i = 0; i < this.nbQuestions; i++) {
      ...
      const fig2 = texteParPosition('Figure 2', (tetris2.rectangle.xMin + tetris2.rectangle.xMax) / 2 + decalage, tetris2.rectangle.yMin - 0.5, undefined, undefined, undefined, 'gauche')
