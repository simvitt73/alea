  ...
  nouvelleVersion() {
    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      if (this.niveau === 1) {
        ...
        texteCorr +=
          numAlpha(0) +
          ` Il y a ${n[m]} ${objets} ${qualites[index1][m]} et il y a ${somme} ${objets} possibles. La probabilité que son choix tombe sur l'${article} des ${objets} ${qualites[index1][m]} est :<br> $${texFractionFromString(n[m], somme)}${simplificationDeFractionAvecEtapes(n[m], somme, { couleur1: 'blue', couleur2: '#f15929' })}$.<br>`
        handleAnswers(this, 4 * i, {
          reponse: { value: new FractionEtendue(n[m], somme).texFSD },
        })
        texteCorr +=
          numAlpha(1) +
          ` Il y a ${n[p]} ${objets} ${qualites[index1][p]} et il y a ${somme} ${objets} possibles. La probabilité que son choix tombe sur l'${article} des ${objets} ${qualites[index1][p]} est :<br> $${texFractionFromString(n[p], somme)}${simplificationDeFractionAvecEtapes(n[p], somme, { couleur1: 'blue', couleur2: '#f15929' })}$.<br>`
        handleAnswers(this, 4 * i + 1, {
          reponse: { value: new FractionEtendue(n[p], somme).texFSD },
        })
        texteCorr +=
          numAlpha(2) +
          ` Il y a ${n[q]} ${objets} ${qualites[index1][q]}, donc il y a ${somme} $-$ ${n[q]} $=$ ${somme - n[q]} autres ${objets} et il y a ${somme} ${objets} possibles. La probabilité que son choix ne tombe pas sur l'${article} des ${objets} ${qualites[index1][q]} est :<br> $${texFractionFromString(somme - n[q], somme)}${simplificationDeFractionAvecEtapes(somme - n[q], somme, { couleur1: 'blue', couleur2: '#f15929' })}$.<br>`
        ...
        if (this.niveau > 2) {
          ...
          texteCorr +=
            numAlpha(3) +
            ` L'événement contraire de «${sp(1)}Tomber sur l'${article} des ${objets} ${qualites[index1][m]} ou ${qualites[index1][p]}${sp(1)}» est l'événement «${sp(1)}Tomber sur l'${article} des ${objets} ${qualites[index1][indexEvenementContraire[0]]}, ${qualites[index1][indexEvenementContraire[1]]} ou ${qualites[index1][indexEvenementContraire[2]]}${sp(1)}».`
        } else {
          texte +=
            numAlpha(3) +
