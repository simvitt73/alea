...
export default class MultiplierUnDecimalParPuissanceDeDix extends Exercice {
  constructor () {
    super()
    this.besoinFormulaireCaseACocher = ['Les nombres à multiplier sont entiers', false]
    this.besoinFormulaire2Numerique = ['Type de questions', 3, ' 1 : Dizaines, centaines, milliers\n 2 : Dixièmes, centièmes, millièmes\n 3 : Mélange']
    this.besoinFormulaire3CaseACocher = ['Avec le glisse-nombre pour la correction']
