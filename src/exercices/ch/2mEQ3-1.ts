...
export const titre = "Déterminer l'équation cartésienne d'un cercle"
...
export default class ExerciceTangenteCourbe extends Exercice {
  ...
  nouvelleVersion() {
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      texte += `Déterminer l'équation cartésienne du cercle de rayon ${r} est de centre $(${x1}\\,;\\,${y1})$.`
      ...
      \\end{aligned}$<br>
      L'équation cartésienne du cercle est donc :
