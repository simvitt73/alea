...
export default class PlacerProbabilites extends Exercice {
  ...
  nouvelleVersion() {
    ...
    const lstEchelle: [string, number][] = [
      ['Impossible', 0],
      ['Improbable', 1 / 6],
      ['Peu probable', 2 / 6],
    ...
    if (this.sup) {
      ...
      lstObjet.push(
        latexParCoordonnees('0', 0, y - 0.25, 'black', 20, 20, 'white', 6),
      ) // abscisse 0
      lstObjet.push(
        latexParCoordonnees('1', L, y - 0.25, 'black', 20, 20, 'white', 6),
      ) // abscisse 1
    }
