...
export function gourdes(decimal = false): Probleme {
  ...
  probleme.enonce = `Une école distribue des gourdes réutilisables aux $${data.nb1Fois}$ élèves. Chaque gourde est emballée dans $${data.part1}$ cm de carton recyclé.<br>
