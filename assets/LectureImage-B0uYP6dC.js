var d=Object.defineProperty;var u=(y,h,t)=>h in y?d(y,h,{enumerable:!0,configurable:!0,writable:!0,value:t}):y[h]=t;var c=(y,h,t)=>u(y,typeof h!="symbol"?h+"":h,t);import{P as C}from"./index-BNxTlEvZ.js";import{O as v}from"./ObjetMathalea2D-CXcNXRpD.js";import{p as l}from"./PointAbstrait-Cz1GEocE.js";import{s as g}from"./segmentsVecteurs-BNKXty6l.js";import{t as a}from"./textes-u6miU7yW.js";import{v as m}from"./Vide2d-lYMmc9eB.js";class k extends v{constructor(t,r,n=1,s=1,i="red",o="",e=""){super();c(this,"x");c(this,"y");c(this,"xscale");c(this,"yscale");c(this,"textAbs");c(this,"textOrd");c(this,"stringColor");this.x=t,this.y=r,this.xscale=n,this.yscale=s,this.textAbs=o,this.textOrd=e,this.stringColor=i,this.bordures=[0,0,0,0]}svg(t){const r=this.x/this.xscale,n=this.y/this.yscale,s=l(r,n),i=l(r,0),o=l(0,n),e=s.x===i.x&&s.y===i.y?m():g(i,s,this.stringColor),x=s.x===o.x&&s.y===o.y?m():g(s,o,this.stringColor);return e.styleExtremites="->",x.styleExtremites="->",e.pointilles=5,x.pointilles=5,`	
`+e.svg(t)+`	
`+x.svg(t)+`	
...
//# sourceMappingURL=LectureImage-B0uYP6dC.js.map
