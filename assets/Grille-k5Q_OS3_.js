import{c as g}from"./utilitairesGeometriques-rO8Jz15i.js";import{O as a}from"./ObjetMathalea2D-CXcNXRpD.js";import{s as j}from"./segmentsVecteurs-CZck6NuM.js";class d extends a{constructor(e=-30,t=-30,s=30,o=30,r="gray",l=.4,i=1,h=0){super(),this.color=g(r),this.opacite=l,this.objets=[];let n=e,c=Math.round((s-e)/i);for(let b=0;b<=c;b++){const f=j(n,t,n,o,r);n+=i,f.opacite=this.opacite,h&&(f.pointilles=5),this.objets.push(f)}let p=t;c=Math.round((o-t)/i);for(let b=0;b<=c;b++){const f=j(e,p,s,p,r);p+=i,f.opacite=this.opacite,h&&(f.pointilles=5),this.objets.push(f)}this.bordures=[e,t,s,o]}svg(e){let t="";if(this.objets==null)return t;for(const s of this.objets)t+=`
...
//# sourceMappingURL=Grille-k5Q_OS3_.js.map
