var d=Object.defineProperty;var u=(c,h,t)=>h in c?d(c,h,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[h]=t;var y=(c,h,t)=>u(c,typeof h!="symbol"?h+"":h,t);import{P as C}from"./index-XoLrKcz1.js";import{O as k}from"./ObjetMathalea2D-CXcNXRpD.js";import{p as l}from"./PointAbstrait-Cz1GEocE.js";import{s as g}from"./segmentsVecteurs-D6KrHz1l.js";import{t as a}from"./textes-JaA0Oga4.js";import{v as m}from"./Vide2d-lYMmc9eB.js";class v extends k{constructor(t,o,i,s,n="black",r,e){super();y(this,"x");y(this,"y");y(this,"xscale");y(this,"yscale");y(this,"textAbs");y(this,"textOrd");y(this,"stringColor");this.x=t,this.y=o,this.xscale=i,this.yscale=s,this.textAbs=e,this.textOrd=r,this.stringColor=n,this.bordures=[0,0,0,0]}svg(t){const o=this.x/this.xscale,i=this.y/this.yscale,s=l(o,i),n=l(o,0),r=l(0,i),e=s.x===n.x&&s.y===n.y?m():g(s,n,this.stringColor),x=s.x===r.x&&s.y===r.y?m():g(r,s,this.stringColor);return e.styleExtremites="->",x.styleExtremites="->",e.pointilles=5,x.pointilles=5,`	
`+e.svg(t)+`	
`+x.svg(t)+`	
...
//# sourceMappingURL=LectureAntecedent-sX5zKH6r.js.map
